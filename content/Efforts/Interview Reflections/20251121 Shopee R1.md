...
### Bonus: Multiple Downstream services

Voucher Claim can trigger multiple downstream actions.

e.g., Queue Topic: `voucher.claimed` -- 

- Subscriber 1: Email Service (sends voucher code)
- Subscriber 2: Analytics Service (tracks conversion)
- Subscriber 3: Recommendation Service (updates user profile)
- ...
